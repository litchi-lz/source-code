<template>
  <div class="desktop">
    <div :class="{ 'shadow': active < bookeSize - 1, 'center': active > 0 && active <= bookeSize - 1, 'center-back': active == bookeSize }"
      class="book">
      <div @click.stop="handlerPage(index)" :style="{ 'z-index': zIndex[index] }"
        :class="{ 'active': active == index, 'flipped': active > index }" v-for="(item, index) in bookeSize " :key="index"
        class="book-page">
        <div class="front">
          <div class="opt">
